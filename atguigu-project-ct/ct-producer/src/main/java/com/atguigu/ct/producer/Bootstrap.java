...
//        producer.setIn(new LocalFileDataIn("D:\\coder\\mylearn\\files\\2.资料\\辅助文档\\contact.log"));
//        producer.setOut(new LocalFileDataOut("D:\\coder\\mylearn\\files\\2.资料\\辅助文档\\call.log"));
